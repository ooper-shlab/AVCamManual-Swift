...
class AAPLCameraViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
    ...
    private func addObservers() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(subjectAreaDidChange(_:)), name: .AVCaptureDeviceSubjectAreaDidChange, object: self.videoDevice!)
        NotificationCenter.default.addObserver(self, selector: #selector(sessionRuntimeError(_:)), name: .AVCaptureSessionRuntimeError, object: self.session)
    ...
    @IBAction func changeCamera(_: AnyObject) {
        ...
        self.sessionQueue.async {
            ...
            if self.session.canAddInput(newVideoDeviceInput) {
                ...
                NotificationCenter.default.addObserver(self, selector: #selector(self.subjectAreaDidChange(_:)), name: .AVCaptureDeviceSubjectAreaDidChange, object: newVideoDevice)
    ...
    private func setSlider(_ slider: UISlider, highlightColor color: UIColor) {
    ...
    private func stringFromFocusMode(_ focusMode: AVCaptureFocusMode) -> String {
        var string: String
    ...
    private func stringFromExposureMode(_ exposureMode: AVCaptureExposureMode) -> String {
        var string: String
    ...
    private func stringFromWhiteBalanceMode(_ whiteBalanceMode: AVCaptureWhiteBalanceMode) -> String {
        var string: String
